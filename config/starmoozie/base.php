...
return [
    ...
    */
    ...
    'scripts' => [
        ...
        'packages/starmoozie/base/js/bundle.js',
    ...
    */
    ...
    // You can make sure all your URLs use this prefix by using the starmoozie_url() helper instead of url()
    'route_prefix' => 'admin',
    ...
    */
    ...
    // Starmoozie will prevent visitors from requesting password recovery too many times
    ...
    // Starmoozie will prevent an IP from trying to reset the password too many times,
    ...
    */
    ...
    // 'user_model_fqn' => \Starmoozie\LaravelMenuPermission\app\Models\User::class, // works if using starmoozie/laravel-menu-permission
    ...
    'middleware_class' => [
        ...
        // \Starmoozie\CRUD\app\Http\Middleware\UseStarmoozieAuthGuardInsteadOfDefaultAuthGuard::class,
    ],

    // Alias for that middleware
    'middleware_key' => 'admin',
    // Note: It's recommended to use the starmoozie_middleware() helper everywhere, which pulls this key for you.

    // Username column for authentication
    // The Starmoozie default is the same as the Laravel default (email)
    // If you need to switch to username, you also need to create that column in your db
    'authentication_column'      => 'email',
    'authentication_column_name' => 'Email',

    // The guard that protects the Starmoozie admin panel.
    // If null, the config.auth.defaults.guard value will be used.
    'guard' => 'starmoozie',

    // The password reset configuration for Starmoozie.
    ...
    |--------------------------------------------------------------------------
    */
    // Change the view namespace in order to load a different theme than the one Starmoozie provides.
    // You can create child themes yourself, by creating a view folder anywhere in your resources/views
    // and choosing that view_namespace instead of the default one. Starmoozie will load a file from there
    // if it exists, otherwise it will load it from the default namespace ("starmoozie::").

    'view_namespace' => 'starmoozie::',
    ...
    */
    ...
    // Starmoozie\Base sets up its own filesystem disk, just like you would by
    // adding an entry to your config/filesystems.php. It points to the root
    // of your project and it's used throughout all Starmoozie packages.
    //
